...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mCurrentNavPosition = savedInstanceState.getInt(SELECTED_POSITION);
    ...
    private void setupTabs(int position){
        ...
        final ToolPagerAdapter toolPagerAdapter = new ToolPagerAdapter(
                getSupportFragmentManager(),getResources(), mToolTypes[position]);
